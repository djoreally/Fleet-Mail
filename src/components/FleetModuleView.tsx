...
import{ProspectCrudWorkspace}from'./operations/ProspectCrudWorkspace';
...
import{ConnectedVehicleWorkspace}from'./vehicles/ConnectedVehicleWorkspace';
...
const ProspectingLive=()=> <div className="flex min-h-0 flex-1 flex-col"><ProspectInboxSyncButton/><ProspectCrudWorkspace/></div>;
