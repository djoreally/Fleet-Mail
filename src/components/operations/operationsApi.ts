...
export type CustomerRow = { id:string; name:string; accountNumber?:string|null; billingEmail?:string|null; phone?:string|null; status:string; vehicleCount:number; primaryContact?:string|null; contactEmail?:string|null; spend30Days:string };
