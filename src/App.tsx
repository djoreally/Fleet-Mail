...
function InboxPage({ go }: { go: (page: PageId) => void }) {
  ...
  return <PageFrame>
    <SectionHeading eyebrow="AgentMail Inbox · fleet@redwood.agentmail.to" title="Fleet Inbox" description="Incoming customer service requests, authorizations, and driver reports automatically triaged for Fleet OS." action={<Button icon={Plus} onClick={() => go('work-orders')}>Create work order</Button>} />
