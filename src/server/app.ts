...
export function createApp() {
  ...
  app.use('/api',dashboardRouter);app.use('/api',agentMailAttachmentsRouter);app.use('/api',vehicleManagementRouter);app.use('/api',apiRouter);app.use('/api',vehicle360Router);app.use('/api/google',googleRouter);app.use('/api/team',teamRouter);app.use('/api/technician',technicianRouter);app.use('/api/dispatcher',dispatcherRouter);app.use('/api/agentmail/crud',agentmailCrudRouter);app.use('/api/agent/actions',agentActionsRouter);app.use('/api/operations',operationsRouter);app.use('/api/operations',customerPartsRouter);app.use('/api/operations',maintenanceIntelligenceRouter);app.use('/api/operations',workOrderCompletionRouter);app.use('/api/operations',workOrderExecutionRouter);app.use('/api/operations',prospectingRouter);app.use('/api/fleet-service',fleetServiceRouter);app.use('/api/fleet-operations',scheduleDispatchRouter);app.use('/api/fleet',paymentReconciliationRouter);app.use('/api/fleet',financialReadModelRouter);app.use('/api/fleet',financialDocumentsRouter);return app;
}
